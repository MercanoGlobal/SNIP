	...
	<div class="col-12 col-sm-12 col-lg-12">
		<form action="<?php echo base_url(); ?>" method="post" class="form-vertical well" enctype="multipart/form-data">
			...
			<?php if ($this->config->item('file_upload')) { ?>
				<div class="row">
					<div class="col-md-12">
						<label for="file"><?php echo lang('attach_file'); ?>:</label>
			...
			<div class="item_group">
				<div class="item item_captcha">
                    ...
                    <?php if($use_recaptcha){
                        ...
                        <input class="captcha" value="" type="text" id="captcha" name="captcha" tabindex="2" maxlength="32" style="margin:6px 0 6px 0;" />
                    <?php } ?>
				</div>
			</div>
		<?php } ?>
			<div class="form-actions">
				...
				<button type="submit" id="master-submit" name="submit" value="submit" class="btn btn-large btn-primary">
