...
<section>
    ...
    if (!empty($file)) {
        ...
        if (in_array($fileExtension, $rendered_image_extensions)) {
            ...
            echo '<div class="row"><div class="col-12 col-sm-12 col-lg-12 text-center">';
            echo '<img src="' . $file_path . '" alt="File Preview" width="50%;" /><br>';
            ...
            echo '<div class="row"><div class="col-12 col-sm-12 col-lg-12 text-center">';
            echo '<video width="90%" height="auto" controls><source src="' . $file_path . '" alt="File Preview" />Your browser does not support the video tag.</video><br>';
            echo '<div style="text-align:center;"><a href="' . $file_path . '" download>Download ' . $fileType . ' Attachment</a></div>';
            echo '</div></div><br>';
