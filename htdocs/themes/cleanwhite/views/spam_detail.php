...
<h1><a href="<?php echo site_url('spamadmin'); ?>">Spamadmin</a> - Pastes for IP <a target="_blank" title="Check IP" href="https://tools.keycdn.com/geo?host=<?php echo $ip_address; ?>"><?php echo $ip_address; ?></a></h1>
